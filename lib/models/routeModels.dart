...
class RoutePart{
    ...
    factory RoutePart.fromJson(Map<String, dynamic> json) => _$RoutePartFromJson(json);
...
class MeansOfTransportation{
    ...
    factory MeansOfTransportation.fromJson(Map<String, dynamic> json) => _$MeansOfTransportationFromJson(json);
